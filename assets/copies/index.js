...
var app = angular.module('cynapse', ['ui.router', 'angularCSS']);
...
app.config(function ($stateProvider, $urlRouterProvider) {
    ...
    $stateProvider
        .state('main', {
            ...
            controller: 'MainCtrl',
            css: [{href: '..assets/styles/style.css'}]
        ...
        .state('about', {
            ...
            css: [{href: '../../assets/styles/materialize.min.css'}, {href:'../../assets/styles/animates.min.css'}, {href:'../../assets/styles/about_style.css'}, {href:'../../assets/styles/animate.css'}]
        ...
        .state('contact', {
            ...
            controller: 'ContactCtrl',
                css: [{href:'..assets/styles/style.css'},{href:'../assets/styles/materialize.min.css'} ]
        });
...
app.controller('AboutCtrl', function ($scope, $css) {

    console.log("I'm in!!!1");
    $css.remove('..assets/styles/style.css');
...
app.controller('MainCtrl', function ($scope) {
    ...
    function showDetails(name) {
        ...
        $('.flipper').addClass('hide');
        $('#' + name).removeClass('hide');
        try{
          $('[id$="-toggle"]').addClass('i');
          // $('#events' + '-toggle').addClass('i');
          // $('#details' + '-toggle').addClass('i');
        }catch(err){
...
app.directive('myMap', function() {
    ...
    var link = function(scope, element, attrs) {
        ...
        // map config
        var mapOptions = {
            center: new google.maps.LatLng(13.357146, 80.142936),
            zoom: 16,
        ...
        setMarker(map, new google.maps.LatLng(13.357146, 80.142936), 'The next Big Event', 'We are here! Join us');
    };
